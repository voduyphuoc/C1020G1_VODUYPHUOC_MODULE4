...
public class Service {
    ...
    public Service(String id, String name, String area, String cost, String maxPeople, String standardRoom, String description, String poolArea, String numberOfFloors) {
        this.id = id;
        this.name = name;
        this.area = area;
        this.cost = cost;
